...
`,n=s(o,R,g),i=o.getAttribLocation(n,"onePosition"),b=o.getAttribLocation(n,"oneRotate"),r=new Float32Array([0,.1,-.1,-.1,.1,-.1]),d=o.createBuffer();o.bindBuffer(o.ARRAY_BUFFER,d);o.bufferData(o.ARRAY_BUFFER,r,o.STATIC_DRAW);const a=2;o.vertexAttribPointer(i,a,o.FLOAT,!1,0,0);o.enableVertexAttribArray(i);let P=.02,f=1,e=0;new c(()=>{e+=P*f,o.vertexAttrib1f(b,e),o.drawArrays(o.TRIANGLES,0,r.length/a)},60);
